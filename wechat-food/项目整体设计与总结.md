...
前端是由Vue.js构建的WebApp，后端由Spring Boot打造，后端的前台页面使`用Bootstrap+Freemarker+JQuery`构建,后端和前端通过==RESTful==风格的接口相连。

![34.png](/Users/jc/Documents/JavaNote/wechat-food/34.jpg)
...
![21.png](/Users/jc/Documents/JavaNote/wechat-food/21.jpg)
...
![36.png](/Users/jc/Documents/JavaNote/wechat-food/36.jpg)
...
![image-20190715143354111](/Users/jc/Library/Application Support/typora-user-images/image-20190715143354111.png)
...
![image-20190715145324732](/Users/jc/Library/Application Support/typora-user-images/image-20190715145324732.png)
...
- 涉及==金额的属性用decimal==类型：decimal(8,2)代表一共八位数，其中有两位小数。
...
![image-20190718210233984](/Users/jc/Library/Application Support/typora-user-images/image-20190718210233984.png)
...
![image-20190723174657481](/Users/jc/Library/Application Support/typora-user-images/image-20190723174657481.png)
...
![image-20190722174557677](/Users/jc/Library/Application Support/typora-user-images/image-20190722174557677.png)
...
![image-20190720153113041](/Users/jc/Library/Application Support/typora-user-images/image-20190720153113041.png)
...
![订单创建流程](/Users/jc/Documents/JavaNote/wechat-food/订单创建流程.png)
...
`productInfoList.stream().map(e->e.getCategoryType())`就是将集合中商品的种类映射为一个Stream，它是一个中间流，再看后面一部分`collect(Collectors.toList())`，它表示==收集中间流==并变成一个List。 
