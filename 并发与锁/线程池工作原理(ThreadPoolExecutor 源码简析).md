...
> <font color='#02C874' size=4>**线程池解决的核心问题就是资源管理问题。在并发坏境下，系统不能够确定在任意时刻中，有多少任务需要执行，有多少资源需要投入。**</font>这种不确定性将带来以下若干问题：
>
...
> - <font color='red' size = 4>***核心就是线程池的参数难以配置，可通过动态调整参数解决***</font>
